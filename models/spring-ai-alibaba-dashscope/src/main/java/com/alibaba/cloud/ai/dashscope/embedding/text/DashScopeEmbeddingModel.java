...
public class DashScopeEmbeddingModel extends AbstractEmbeddingModel {
	...
	private final com.alibaba.cloud.ai.dashscope.embedding.text.DashScopeEmbeddingOptions defaultOptions;
	...
	public DashScopeEmbeddingModel(DashScopeApi dashScopeApi, MetadataMode metadataMode,
			com.alibaba.cloud.ai.dashscope.embedding.text.DashScopeEmbeddingOptions dashScopeEmbeddingOptions) {
		this(dashScopeApi, metadataMode, dashScopeEmbeddingOptions, RetryUtils.DEFAULT_RETRY_TEMPLATE);
	}

	public DashScopeEmbeddingModel(DashScopeApi dashScopeApi, MetadataMode metadataMode,
                                   com.alibaba.cloud.ai.dashscope.embedding.text.DashScopeEmbeddingOptions dashScopeEmbeddingOptions, RetryTemplate retryTemplate) {
		this(dashScopeApi, metadataMode, dashScopeEmbeddingOptions, retryTemplate, ObservationRegistry.NOOP);
	}

	public DashScopeEmbeddingModel(DashScopeApi dashScopeApi, MetadataMode metadataMode,
                                   com.alibaba.cloud.ai.dashscope.embedding.text.DashScopeEmbeddingOptions options, RetryTemplate retryTemplate, ObservationRegistry observationRegistry) {
    ...
    public static final class Builder {
        ...
        private com.alibaba.cloud.ai.dashscope.embedding.text.DashScopeEmbeddingOptions defaultOptions = com.alibaba.cloud.ai.dashscope.embedding.text.DashScopeEmbeddingOptions.builder()
					.model(DashScopeApi.DEFAULT_EMBEDDING_MODEL)
					.textType(DashScopeApi.DEFAULT_EMBEDDING_TEXT_TYPE)
					.build();
        ...
        public Builder defaultOptions(com.alibaba.cloud.ai.dashscope.embedding.text.DashScopeEmbeddingOptions defaultOptions) {
