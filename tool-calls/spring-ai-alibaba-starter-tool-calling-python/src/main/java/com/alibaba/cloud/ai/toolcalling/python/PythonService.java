 ...
 */
public class PythonService implements BiFunction<PythonService.Request, @Nullable ToolContext, PythonService.Response> {
    ...
    @Override
    public Response apply(Request request, @Nullable ToolContext toolContext) {
